...
###' 
###'  [Table 01]. Meta-model regression results for triple goals
###'           
###' Data: Simulated data
###' 
###' Data: 2020-04-26
...
write.csv(bind_cols(list_df_fit), 
          file = "01_Regression table_01_SSEL individual effects.csv")

write.csv(bind_cols(list_df_fit_pub), 
          file = "01_Regression table_01_SSEL individual effects_Pub.csv")
...
###' Fit meta-models & save the tables as .csv file
###' 
###' (2) ISEL for the empirical distribution function (EDF)
###'
###'
...
write.csv(bind_cols(list_df_fit), 
          file = "01_Regression table_02_ISEL for EDF.csv")

write.csv(bind_cols(list_df_fit_pub), 
          file = "01_Regression table_02_ISEL for EDF_Pub.csv")
...
write.csv(bind_cols(list_df_fit), 
          file = "01_Regression table_03_SSEL for rank.csv")

write.csv(bind_cols(list_df_fit_pub), 
          file = "01_Regression table_03_SSEL for rank_Pub.csv")
