...
###'  
###'   (1) The effect of CB and GR on loss estimates (MSELR only)
###'   
###'   (2) The effect of DP priors on loss estimates (MSELR only)
###'   
###'           
###' Data: Simulated data
###' 
...
###' [Figure 06-01]. 
###' 
###' [Panel A] Effects of est on the MSEL of ranks (N = 25)
###' 
...
pA <- ggplot(data = df_plot_sub, 
  ...
  labs(title = "The effect of CB and GR on the MSEL of ranks (N = 25)", 
...
###' [Figure 06-01]. 
###' 
###' [Panel B] Effects of est on the MSEL of ranks (N = 200)
###' 
###' By shrinkage factor (I) & data-analytic model (anl)
###' 
###'
...
pB <- ggplot(data = df_plot_sub, 
  ...
  theme(strip.background = element_rect(fill = "gray100")) + 
  theme(legend.position = "right", legend.direction = "vertical") + 
  labs(title = "The effect of CB and GR on the MSEL of ranks (N = 200)", 
       # subtitle = "Estimator: PM", 
       y = "Effect estimate", x = NULL)
...
###' [Figure 07-01]. 
###' 
###' [Panel A] Effects of anl on the MSEL of ranks (N = 25, GR)
###' 
...
pC <- ggplot(data = df_plot_sub, 
  ...
  theme(strip.background = element_rect(fill = "gray100")) + 
  theme(legend.position = "right", legend.direction = "vertical") + 
  labs(title = "The effect of DP priors on the MSEL of ranks (N = 25, GR)", 
       # subtitle = "Estimator: PM", 
       y = "Effect estimate", x = NULL)
...
###' [Figure 07-01]. 
###' 
###' [Panel B] Effects of anl on the MSEL of ranks (N = 200, GR)
###' 
###' By shrinkage factor (I) & data-generating models (truth)
###' 
###'
...
pD <- ggplot(data = df_plot_sub, 
  ...
  theme(strip.background = element_rect(fill = "gray100")) + 
  theme(legend.position = "right", legend.direction = "vertical") + 
  labs(title = "The effect of DP priors on the MSEL of ranks (N = 200, GR)", 
       # subtitle = "Estimator: PM", 
       y = "Effect estimate", x = NULL)
...
###'######################################################################
###'
###' Combine all four plots into one (or two) 
###' 
###'
...
ggsave("figures/Figure06-01_Effects of CB and GR on loss estimates_01_Mixed_MSELR.pdf", 
...
ggsave("figures/Figure07-01_Effects of DP priors on loss estimates_MSELR.pdf", 
